      ...
      {step === 3 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              Enter your login credentials and click the login button to login!
      ...
      {step === 4 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              Use the Saved Recipes button to navigate to the saved recipes
              page!
            </p>
            <div class="back-next-buttons">
              <button onClick={prevStep}>Back</button>
      ...
      {step === 5 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              Click on the create recipe button in the corner to begin creating
              a recipe!
            </p>
            <div class="back-next-buttons">
              <button onClick={prevStep}>Back</button>
      ...
      {step === 6 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              Enter your recipe details and press submit to save the recipe!
            </p>
            <div class="back-next-buttons">
              <button onClick={prevStep}>Back</button>
              <button onClick={nextStep}>Next</button>
      ...
      {step === 7 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              Now that your recipe has been saved, click on the recipe to view
              it's details! Note that pressing the edit button will allow you to
              change the details of a recipe!
            </p>
            <div class="back-next-buttons">
              <button onClick={prevStep}>Back</button>
              <button onClick={nextStep}>Next</button>
      ...
      {step === 8 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              This page shows the top of the details of the selected recipe! Use
              the navigation bar at the top to return to either the home page or
      ...
      {step === 9 && (
        <>
          ...
          <div class="helper-modal">
            ...
            <p>
              This page shows the meal multiplier which changes the quantity of
              the ingredients as well as the nutritional summary!
            </p>
            <div class="back-next-buttons">
              <button onClick={prevStep}>Back</button>
              <button onClick={nextStep}>Next</button>
